...
Stream::EByteOrder Stream::m_hostByteOrder = Stream::ELittleEndian; //Supose it's always like this
...
/// Swaps the byte order of the underlying representation (Shouldn't be defined here, but getting all util for this is pointless)
...
//NORI_REGISTER_CLASS(Stream, "stream") No se si hace falta
