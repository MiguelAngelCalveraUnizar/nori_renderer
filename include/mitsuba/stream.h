...
class Stream : public NoriObject {
public:
    ...
    EClassType getClassType() const { return EStream; }
...
template <typename T> inline T Stream::readElement() {
    throw NoriException("Stream::readElement<T>: not implemented!");
}

template <typename T> inline void Stream::writeElement(T value) {
    throw NoriException("Stream::writeElement<T>: not implemented!");
}

template <typename T> inline void Stream::readArray(T *array, size_t count) {
    throw NoriException("Stream::readArray<T>: not implemented!");
}

template <typename T> inline void Stream::writeArray(const T *array, size_t count) {
    throw NoriException("Stream::writeArray<T>: not implemented!");
}
...
extern std::ostream &operator<<(std::ostream &os, const Stream::EByteOrder &value);
